...
const ACTION_LABEL: Record<string, string> = {
  ...
  "summary.create": "Created discharge summary",
  "summary.update": "Updated discharge summary",
  "summary.finalize": "Finalized discharge summary",
  "summary.archive": "Deleted discharge summary",
  "summary.document.download": "Downloaded summary PDF",
